...
const countries: Country[] = [
  ...
  { name: 'Abkhazia', code: 'AB', callingCode: '7840', flag: '🇦🇧' },
  { name: 'South Ossetia', code: 'OS', callingCode: '7840', flag: '🇴🇸' },
  { name: 'Transnistria', code: 'PMR', callingCode: '373', flag: '🇵🇲' },
  { name: 'Artsakh', code: 'NKR', callingCode: '374', flag: '🇦🇿' },
  { name: 'Northern Cyprus', code: 'CYP', callingCode: '90', flag: '🇨🇾' },
  { name: 'Sahrawi Arab Democratic Republic', code: 'SAH', callingCode: '212', flag: '🇪🇭' },
  { name: 'Somaliland', code: 'SOL', callingCode: '252', flag: '🇸🇴' },
  { name: 'Taiwan', code: 'TW', callingCode: '886', flag: '🇹🇼' },
  { name: 'Hong Kong', code: 'HK', callingCode: '852', flag: '🇭🇰' },
  { name: 'Macau', code: 'MO', callingCode: '853', flag: '🇲🇴' },
];
